<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      <div class="page-title">
        <a href="" class="btn btn-primary pull-right" data-toggle="modal" data-target="#formOspek" ng-click="pembayaranOspekTerakhir()">Bayar Ospek</a>
      </div>
      <table id="tableMahasiswa" class="table table-hover table-bordered">
        ...
        <tbody>
          <tr ng-repeat="dt in mahasiswa.biayaOspek" class="active">
            <td><h4>@{{dt.tanggalBayar}}</h4></td>
            <td><h4>@{{dt.jumlahBayar | number}}</h4></td>
            <td><h4>@{{dt.sisa | number}}</h4></td>
            <td><h4>@{{dt.status}}</h4></td>
            <td class="text-center"><a href="" class="btn btn-info" ng-click="test('ospek', dt.id)"> <span class="fa fa-print"></span> </a></td>
          </tr>
        </tbody>
        <tfoot>
        </tfoot>
  ...
  <!-- Modal -->
  <div id="formOspek" class="modal fade" role="dialog">
    <div class="modal-dialog">
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header btn-success">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Form Pembayaran Ospek</h4>
        </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-success" data-dismiss="modal" ng-click="pembayaranOspek()">Simpan</button>
        </div>
      </div>
    </div>
  </div>
